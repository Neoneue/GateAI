...
4. **Most-recent session decision logs** (read these for "what changed yesterday and why"):
   ...
   - `~/.claude/projects/-Users-cponticas-Documents-GitHub-mvp/memory/MEMORY.md` — index of all feedback memories (vendor avatar locked to brand chip, no blue links, two-tier material ladder, color system structure, three-tier table ink density)
